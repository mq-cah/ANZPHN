...
: **Application**: A cover letter; CV; and project description for PhD project. _See flyer below for more information_. Send application to <phacs@uni.lu>.
: **Closing date**: January 22, 2023 at midnight CET (Luxembourg time)
: **More information**: Please read [this information flyer]({{ site.baseurl }}/assets/files/PHACS_AFR_call.pdf){:target="_blank"} _before_ applying
